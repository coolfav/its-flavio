  ...
  return (
    <div className="App">
      ...
      <div className="this-website">
        <p>This website</p>
        <p style={{'font-size': '80%', 'padding-left':'2%', 'color' : 'white'}}>_Made completely from scratch using React and Github hosting</p>
        <p style={{'font-size': '80%', 'padding-left':'2%', 'color' : 'white'}}>_No generative AI was used in the creation of this website</p>
        <p style={{'font-size': '80%', 'padding-left':'2%', 'color' : 'white'}}>_Still a WIP</p>
      </div>
